...
TEST_CASE("MattsExampleFromVideo", "[FYI]")
{
    ...
    std::ifstream _profsin{"test3_classprefs.txt"};
    std::ifstream _tasin{"test3_taprefs.txt"};
...
TEST_CASE("100x100", "[FYI]")
{
    std::ifstream profsin{"test4_classprefs.txt"};
    std::ifstream tasin{"test4_taprefs.txt"};
    std::unordered_map<unsigned, unsigned> matching;
    constexpr unsigned NUM_TAS_and_CLASSES = 100;

    std::ifstream _profsin{"test4_classprefs.txt"};
    std::ifstream _tasin{"test4_taprefs.txt"};
...
TEST_CASE("500x500", "[FYI]")
{
    std::ifstream profsin{"test5_classprefs.txt"};
    std::ifstream tasin{"test5_taprefs.txt"};
    std::unordered_map<unsigned, unsigned> matching;
    constexpr unsigned NUM_TAS_and_CLASSES = 500;

    std::ifstream _profsin{"test5_classprefs.txt"};
    std::ifstream _tasin{"test5_taprefs.txt"};
...
TEST_CASE("1000x1000", "[FYI]")
{
    std::ifstream profsin{"test6_classprefs.txt"};
    std::ifstream tasin{"test6_taprefs.txt"};
    std::unordered_map<unsigned, unsigned> matching;
    constexpr unsigned NUM_TAS_and_CLASSES = 1000;

    std::ifstream _profsin{"test6_classprefs.txt"};
    std::ifstream _tasin{"test6_taprefs.txt"};
...
TEST_CASE("2000x2000", "[FYI]")
{
    std::ifstream profsin{"test7_classprefs.txt"};
    std::ifstream tasin{"test7_taprefs.txt"};
    std::unordered_map<unsigned, unsigned> matching;
    constexpr unsigned NUM_TAS_and_CLASSES = 2000;

    std::ifstream _profsin{"test7_classprefs.txt"};
    std::ifstream _tasin{"test7_taprefs.txt"};
